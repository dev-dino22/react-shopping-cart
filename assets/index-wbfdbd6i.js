...
function Flex({ className, children, ...props }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Container$i, { className, ...props, children });
}
const Container$i = newStyled.div`
  width: 100%;
  display: flex;
...
`;
function Loading() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Container$h, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingImg, { src: "./assets/gifs/Loading.gif", alt: "로딩 스피너" }) });
}
const Container$h = newStyled.div`
  width: 100%;
  height: 100%;
  display: flex;
...
function MobileLayout({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Flex, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Container$g, { children }) });
}
const Container$g = newStyled.div`
  width: 440px;
...
function useAPIDataContext({
  ...
  const request = reactExports.useCallback(async () => {
    ...
    try {
      ...
      setState((prev2) => ({
        ...prev2,
        [name]: { ...prev2[name], loading: false, error: e3 }
      }));
...
const OrderListProvider = ({ children }) => {
  ...
  const [isIsland, setIsIsland] = reactExports.useState(false);
  const [discount, setDiscount] = reactExports.useState(0);
  reactExports.useEffect(() => {
    localStorage.setItem(STORAGE_KEY, JSON.stringify(selectedCartItems));
  }, [selectedCartItems]);
  const handleIsIslandToggle = reactExports.useCallback(() => {
    setIsIsland((prev2) => !prev2);
  }, [setIsIsland]);
  const handleDiscountSetting = reactExports.useCallback(
    (discountAmount) => {
...
const useOrderListContext = (cartListData) => {
  const {
    selectedCartItems,
    setSelectedCartItems,
    isIsland,
    ...
    discount,
    handleDiscountSetting
  } = reactExports.useContext(OrderListContext);
  ...
  reactExports.useEffect(() => {
    if (!cartListData)
      return;
    setSelectedCartItems(
      (prev2) => prev2.filter((item) => cartListData.some((cart) => cart.id === item.id))
    );
  }, [cartListData, setSelectedCartItems]);
  const orderIdList = reactExports.useMemo(
...
function useOrderCalculation(selectedCartItems, isIsland, discount = 0) {
  return reactExports.useMemo(() => {
    ...
    const shippingFee = (totalCartPrice >= FREE_SHIPPING_STANDARD || totalCartPrice === 0 ? 0 : SHIPPING_FEE) + (isIsland ? ISLAND_SHIPPING_FEE : 0);
...
function OrderInfoTitle() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Flex, { justifyContent: "flex-start", alignItems: "flex-start", gap: "xs", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Description$1, { children: "최종 결제 금액을 확인해 확인해 주세요." })
  ] });
}
const InfoTitle$1 = newStyled.h2`
  font-size: 24px;
  font-weight: bold;
  margin-bottom: 12px;
`;
...
function Image({
  ...
  const [imageUrl, setImageUrl] = reactExports.useState(src);
  reactExports.useEffect(() => {
    setImageUrl(src);
  }, [src]);
...
`;
function formatKRWString(price) {
...
function OrderList() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Container$f, { children: orderIdList.map((id) => {
    const cart = (cartListData ?? []).find((cart2) => cart2.id === id);
    if (!cart)
      return null;
    return /* @__PURE__ */ jsxRuntimeExports.jsx(ItemWithCheckboxContainer$1, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(ItemContainer$1, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(ProductInfo$1, { "aria-label": "상품 정보", role: "cart-product-info", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(NamePriceContainer, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ProductName$1, { children: cart.product.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ProductPrice$1, { children: formatKRWString(cart.product.price) })
        ] }),
...
const Container$f = newStyled.div`
  width: 100%;
  height: 300px;
  display: flex;
...
`;
const ItemWithCheckboxContainer$1 = newStyled.div`
  display: flex;
  flex-direction: column;
  &:last-child {
    border-bottom: none;
...
`;
const ItemContainer$1 = newStyled.div`
  display: flex;
  gap: 16px;
  padding: 16px 0;
  border-bottom: 1px solid #f0f0f0;
...
`;
const NamePriceContainer = newStyled.div`
  display: flex;
  flex-direction: column;
  align-items: flex-start;
  gap: 4px;
...
function OrderContents() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Container$e, { justifyContent: "flex-start", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(OrderInfoTitle, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(OrderList, {})
  ] });
}
const Container$e = newStyled(Flex)`
  padding: 36px 24px;
`;
function mr(e22) {
...
function Mr(e22, r2) {
  for (; --r2 && I() && !(R < 48 || R > 102 || R > 57 && R < 65 || R > 70 && R < 97); )
    ;
  return se(e22, de() + (r2 < 6 && Y() == 32 && I() == 32));
}
function Re(e22) {
  for (; I(); )
    switch (R) {
...
function Dr(e22, r2) {
  for (; I() && e22 + R !== 57; )
    if (e22 + R === 84 && Y() === 47)
      break;
  return "/*" + se(r2, N - 1) + "*" + ge(e22 === 47 ? e22 : I());
}
function Lr(e22) {
  for (; !ie(Y()); )
    I();
...
function pe(e22, r2, t2, n2, a, c2, d2, p2, l2) {
  for (var o = 0, f2 = 0, s = d2, i = 0, h2 = 0, b2 = 0, m2 = 1, y2 = 1, x2 = 1, S = 0, A2 = "", $ = a, F = c2, T = n2, O = A2; y2; )
    switch (b2 = S, S = I()) {
      case 40:
      ...
      case 0:
        switch (S) {
          ...
          case 59:
            O += ";";
          default:
            if (le(T = Be(O, r2, t2, o, f2, a, p2, A2, $ = [], F = [], s), c2), S === 123)
              if (f2 === 0)
                pe(O, r2, T, T, $, c2, s, p2, F);
              else
                switch (i === 99 && C(O, 3) === 110 ? 100 : i) {
                  ...
                  case 109:
                  case 115:
                    pe(e22, T, T, n2 && le(Be(e22, T, T, 0, 0, a, p2, A2, a, $ = [], s), F), a, F, s, p2, n2 ? $ : F);
                    break;
                  default:
                    pe(O, T, T, T, [""], F, 0, p2, F);
                }
      ...
      default:
        ...
        switch (O += ge(S), S * m2) {
          ...
          case 44:
            ...
            break;
          case 64:
            Y() === 45 && (O += fe(I())), i = Y(), f2 = s = B(A2 = O += Lr(de())), S++;
            break;
          case 45:
            b2 === 45 && B(O) == 2 && (m2 = 0);
        }
...
var st = function(r2) {
  ...
  return function() {
    ...
    var m2 = st(function(y2, x2, S) {
      ...
      typeof y2.className == "string" ? $ = Kr(x2.registered, F, y2.className) : y2.className != null && ($ = y2.className + " ");
      var ee = nt(s.concat(F), x2.registered, T);
      $ += x2.key + "-" + ee.name, d2 !== void 0 && ($ += " " + d2);
      var ve = o && p2 === void 0 ? We(A2) : l2, W = {};
      for (var q2 in y2)
        o && q2 === "as" || ve(q2) && (W[q2] = y2[q2]);
      return W.className = $, S && (W.ref = S), /* @__PURE__ */ reactExports.createElement(reactExports.Fragment, null, /* @__PURE__ */ reactExports.createElement(pt, {
        cache: x2,
        serialized: ee,
...
async function getCouponData() {
  ...
  const couponsData = (response ?? []).map(
    (coupon) => convertResponseToCoupon(coupon)
  );
  return couponsData;
}
function convertResponseToCoupon(coupon) {
...
function InfoText({ contentText }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(InfoBox, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(InfoIcon, { src: "./assets/icons/Info.svg", alt: "info 아이콘" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(InfoMessage, { children: contentText })
  ] });
}
...
const InfoIcon = newStyled.img`
  ...
  height: 14px;
`;
function calculateCouponDiscount(coupons, selectedCouponIds, totalCartPrice, shippingFee, selectedCartItems) {
...
const CouponProvider = ({ children }) => {
  ...
  const handleCouponToggle = reactExports.useCallback(
    (couponId) => {
  ...
  const handleCouponSelectionIds = reactExports.useCallback(
    (couponIds) => {
      setSelectedCoupon(couponIds);
    },
    [setSelectedCoupon]
  );
  const initializeCoupons = reactExports.useCallback(
...
const Container$d = newStyled.div`
  width: 100%;
`;
...
function ToastProvider({ children }) {
  ...
  const showToast = reactExports.useCallback((message, type) => {
    ...
    setToasts((prev2) => [...prev2, { id, message, type }]);
  }, []);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(ToastContext.Provider, { value: contextValue, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: toasts.map((toast) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          ToastMessage,
          {
...
function CouponApplyButton({
  ...
  const coupons = reactExports.use(couponsResource);
...
`;
function CheckboxLabel({ isChecked, onToggle, children }) {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          CheckboxLabel,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(CouponTitle, { children: titleText })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          LabelTextPair,
        ...
        details && details.map((detail, index2) => /* @__PURE__ */ jsxRuntimeExports.jsx(LabelTextPair, { labelTextPairArray: detail }, index2))
      ]
    }
  );
}
const Container$b = newStyled(Flex)`
  padding: 14px 0;
  border-bottom: 1px solid #e0e0e0;
  opacity: ${({ disabled }) => disabled ? 0.4 : 1};
  cursor: ${({ disabled }) => disabled ? "not-allowed" : "pointer"};
`;
const CouponTitle = newStyled.p`
  font-size: 20px;
  font-weight: 700;
  color: "black";
`;
...
function CouponCheckList({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Container$a, { children: (coupons ?? []).map((coupon) => {
...
const Container$a = newStyled.ul`
  display: flex;
  flex-direction: column;
  ...
  overflow: auto;
`;
function CouponModalContent({ onClose }) {
  const couponsResource = getCouponData();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Container$9, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(InfoText, { contentText: "쿠폰은 최대 2개까지 사용할 수 있습니다." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(Loading, {}), children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CouponCheckList, { couponsResource }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        CouponApplyButton,
        {
          onClose,
...
function CouponModalButton() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: handleOpen, children: "쿠폰 적용" }),
    isOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
      Zt,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(CouponModalContent, { onClose: handleClose })
      }
    )
  ] });
}
const LabelPrice = ({ label, price, ariaLabel }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(TotalSection, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(TotalAmount, { "aria-label": ariaLabel, children: formatKRWString(price) })
  ] });
};
...
const OrderLabelPridce = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Container$8, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(InfoText, { contentText: InfoTextContent }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(PriceWrapper$1, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(LabelPrice, { label: "주문 금액", price: totalCartPrice }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        LabelPrice,
        {
...
const Container$8 = newStyled(Flex)`
  flex-direction: column;
  gap: 20px;
`;
const PriceWrapper$1 = newStyled(Flex)`
...
function DeliveryInfo() {
  ...
  const { selectedCartItems, isIsland, handleIsIslandToggle, discount } = useOrderListContext(cartListData);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Container$7, { alignItems: "flex-start", gap: "xs", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(CheckboxLabel, { isChecked: isIsland, onToggle: handleIsIslandToggle, children: "제주도 및 도서 산간 지역" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      OrderLabelPridce,
      {
        totalCartPrice,
...
function PayButton$1() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Container$6, { onClick: navigateToSuccessPage, isDisabled: false, children: "결제하기" });
}
const Container$6 = newStyled.button`
  /* position: sticky;
  bottom: 0; */
  width: 100%;
  padding: 16px;
...
function PayContents() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Container$5, { justifyContent: "flex-start", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CouponModalButton, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(DeliveryInfo, {})
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(PayButton$1, {})
  ] });
}
...
const OrderConfirmPage = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(CouponProvider, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(PayContents, {})
  ] });
};
...
const EmptyCartText = newStyled.p`
  ...
  color: grey;
`;
function CartItemCheckbox({ cartId }) {
  const { data: cartListData } = useAPIDataContext({
    fetcher: getShoppingCartData,
    name: "cart"
  });
  ...
  const handleToggleSelection = (cartId2) => {
    setSelectedCartItems((prev2) => {
      const cart = cartListData == null ? void 0 : cartListData.find((item) => item.id === cartId2);
      if (!cart)
        return prev2;
      if (isChecked) {
        return prev2.filter((item) => item.id !== cartId2);
      } else {
        return [...prev2, cart];
      }
    });
...
function CartCheckItem({ cart }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(ItemWithCheckboxContainer, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CartItemCheckbox, { cartId: cart.id }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(ItemContainer, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(ProductInfo, { "aria-label": "상품 정보", role: "cart-product-info", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(ProductPrice, { children: formatKRWString(cart.product.price) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CartItemCounter, { cart })
      ] }),
...
function CartCheckList() {
  ...
  const isSelectAll = (cartListData == null ? void 0 : cartListData.length) === selectedCartItems.length;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Container$3, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ItemList, { children: isCartEmpty ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyCartBox, {}) : cartListData == null ? void 0 : cartListData.map((cart) => /* @__PURE__ */ jsxRuntimeExports.jsx(CartCheckItem, { cart }, cart.id)) })
  ] });
}
...
const SuccessConfirmPage = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Container, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Flex, { justifyContent: "center", alignItems: "center", gap: "lg", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(InfoTitle, { children: "결제 확인" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        InfoTitle,
        {
          ...
          children: formatKRWString(totalPrice)
        }
      )
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(PayButton, { onClick: navigateToCart, isDisabled: false, children: "장바구니로 돌아가기" })
  ] });
};
